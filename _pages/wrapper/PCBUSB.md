...
tag: PCBUSB-Wrapper
type: wrapper
latest: https://github.com/mac-can/PCBUSB-Wrapper/releases/download/v0.2.7/artifacts.zip
srczip: https://github.com/mac-can/PCBUSB-Wrapper/archive/tags/v0.2.7.zip
srctar: https://github.com/mac-can/PCBUSB-Wrapper/archive/tags/v0.2.7s.tar.gz
